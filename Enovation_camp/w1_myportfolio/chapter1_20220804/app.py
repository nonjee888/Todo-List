...
def connect(keyword):
    ...
    return render_template("personal.html",personal_info=personal_info,personal_career_list=personal_career_list, personal_skill_list=personal_skill_list, personal_project_list=personal_project_list)
...
def sign_up():
    ...
    doc_users = {
        "username": username_receive,  # "id" = DB 아이디 변수
    ...
    doc_info = {
        ...
        "name": username_receive,  # info_name의 기본값은 id와 같게
        "birth": "",
        "address": "",
        "phone_number": "",
        "email": "",
